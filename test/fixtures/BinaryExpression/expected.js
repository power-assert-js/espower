...
assert(_ag1._rec(4 !== 4, 'arguments/0'), new _AssertionMessage1(_am1, -1));
assert(_ag2._rec(_ag2._tap(fuga, 'arguments/0/left') !== 4, 'arguments/0'), new _AssertionMessage1(_am2, -1));
assert(_ag3._rec(_ag3._tap(fuga, 'arguments/0/left') === _ag3._tap(piyo, 'arguments/0/right'), 'arguments/0'), new _AssertionMessage1(_am3, -1));
