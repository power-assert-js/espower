...
var _am1 = _pwmeta1(0, 'assert(!truth)', 'path/to/some_test.js', 3);
var _ag1 = new _ArgumentRecorder1(assert, _am1, 0);
var _am2 = _pwmeta1(0, 'assert(!!some)', 'path/to/some_test.js', 5);
...
var _am4 = _pwmeta1(0, 'assert(delete foo.bar)', 'path/to/some_test.js', 9);
var _ag4 = new _ArgumentRecorder1(assert, _am4, 0);
var _am5 = _pwmeta1(0, 'assert(typeof foo !== \'undefined\')', 'path/to/some_test.js', 11);
var _ag5 = new _ArgumentRecorder1(assert, _am5, 0);
var _am6 = _pwmeta1(0, 'assert(typeof foo.bar !== \'undefined\')', 'path/to/some_test.js', 13);
var _ag6 = new _ArgumentRecorder1(assert, _am6, 0);
var _am7 = _pwmeta1(4, 'assert.strictEqual(typeof foo, typeof bar)', 'path/to/some_test.js', 15);
var _ag7 = new _ArgumentRecorder1(assert.strictEqual, _am7, 0);
var _ag8 = new _ArgumentRecorder1(assert.strictEqual, _am7, 1);
assert(_ag1._rec(!_ag1._tap(truth, 'arguments/0/argument'), 'arguments/0'), new _AssertionMessage1(_am1, -1));
assert(_ag2._rec(!_ag2._tap(!_ag2._tap(some, 'arguments/0/argument/argument'), 'arguments/0/argument'), 'arguments/0'), new _AssertionMessage1(_am2, -1));
assert(_ag3._rec(!_ag3._tap(!_ag3._tap(_ag3._tap(foo, 'arguments/0/argument/argument/object').bar, 'arguments/0/argument/argument'), 'arguments/0/argument'), 'arguments/0'), new _AssertionMessage1(_am3, -1));
assert(_ag4._rec(delete _ag4._tap(_ag4._tap(foo, 'arguments/0/argument/object').bar, 'arguments/0/argument'), 'arguments/0'), new _AssertionMessage1(_am4, -1));
assert(_ag5._rec(_ag5._tap(typeof foo, 'arguments/0/left') !== 'undefined', 'arguments/0'), new _AssertionMessage1(_am5, -1));
assert(_ag6._rec(_ag6._tap(typeof _ag6._tap(_ag6._tap(foo, 'arguments/0/left/argument/object').bar, 'arguments/0/left/argument'), 'arguments/0/left') !== 'undefined', 'arguments/0'), new _AssertionMessage1(_am6, -1));
assert.strictEqual(_ag7._rec(typeof foo, 'arguments/0'), _ag8._rec(typeof bar, 'arguments/1'), new _AssertionMessage1(_am7, -1));
