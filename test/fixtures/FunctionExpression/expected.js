...
var _am1 = _pwmeta1(0, 'assert(function (a, b) {return a + b;})', 'path/to/some_test.js', 4);
var _am2 = _pwmeta1(0, 'assert(baz === function (a, b) {return a + b;}(foo, bar))', 'path/to/some_test.js', 6);
var _ag1 = new _ArgumentRecorder1(assert, _am2, 0);
assert(function (a, b) {
    return a + b;
});
