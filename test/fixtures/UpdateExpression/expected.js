...
assert(_ag1._rec(++foo, 'arguments/0'), new _AssertionMessage1(_am1, -1));
assert(_ag2._rec(bar--, 'arguments/0'), new _AssertionMessage1(_am2, -1));
assert.strictEqual(_ag3._rec(++foo, 'arguments/0'), _ag4._rec(bar--, 'arguments/1'), new _AssertionMessage1(_am3, -1));
