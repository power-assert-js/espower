...
assert(_ag1._rec(new Date(), 'arguments/0'), new _AssertionMessage1(_am1, -1));
assert(_ag2._rec(new (_ag2._tap(_ag2._tap(foo, 'arguments/0/callee/object/object').bar, 'arguments/0/callee/object')).Baz(), 'arguments/0'), new _AssertionMessage1(_am2, -1));
assert(_ag3._rec(!_ag3._tap(new Array(_ag3._tap(foo, 'arguments/0/argument/arguments/0'), _ag3._tap(bar, 'arguments/0/argument/arguments/1'), _ag3._tap(baz, 'arguments/0/argument/arguments/2')), 'arguments/0/argument'), 'arguments/0'), new _AssertionMessage1(_am3, -1));
assert.notEqual(_ag4._rec(new Date(), 'arguments/0'), _ag5._rec(new Date('2013-01-12'), 'arguments/1'), new _AssertionMessage1(_am4, -1));
