...
var _am3 = _pwmeta1(0, 'assert(foo[\'bar\'])', 'path/to/some_test.js', 7);
...
var _am5 = _pwmeta1(0, 'assert(foo[propName])', 'path/to/some_test.js', 11);
var _ag5 = new _ArgumentRecorder1(assert, _am5, 0);
var _am6 = _pwmeta1(0, 'assert(foo[func(key)])', 'path/to/some_test.js', 13);
var _ag6 = new _ArgumentRecorder1(assert, _am6, 0);
var _am7 = _pwmeta1(0, 'assert(foo[propName][\'key\'][keys()[\'name\']])', 'path/to/some_test.js', 15);
var _ag7 = new _ArgumentRecorder1(assert, _am7, 0);
var _am8 = _pwmeta1(0, 'assert(foo[propName][\'key\'][keys()[\'name\']])', 'path/to/some_test.js', 17);
var _ag8 = new _ArgumentRecorder1(assert, _am8, 0);
var _am9 = _pwmeta1(2, 'assert.equal(ary1.length, ary2.length)', 'path/to/some_test.js', 19);
var _ag9 = new _ArgumentRecorder1(assert.equal, _am9, 0);
var _ag10 = new _ArgumentRecorder1(assert.equal, _am9, 1);
var _am10 = _pwmeta1(6, 'assert.deepEqual(foo.propName, foo[key])', 'path/to/some_test.js', 21);
var _ag11 = new _ArgumentRecorder1(assert.deepEqual, _am10, 0);
var _ag12 = new _ArgumentRecorder1(assert.deepEqual, _am10, 1);
assert(_ag1._rec(_ag1._tap(foo, 'arguments/0/object').bar, 'arguments/0'), new _AssertionMessage1(_am1, -1));
assert(_ag2._rec(_ag2._tap(_ag2._tap(foo, 'arguments/0/object/object').bar, 'arguments/0/object').baz, 'arguments/0'), new _AssertionMessage1(_am2, -1));
assert(_ag3._rec(_ag3._tap(foo, 'arguments/0/object')['bar'], 'arguments/0'), new _AssertionMessage1(_am3, -1));
assert(_ag4._rec(_ag4._tap(foo, 'arguments/0/object')[_ag4._tap(propName, 'arguments/0/property')], 'arguments/0'), new _AssertionMessage1(_am4, -1));
assert(_ag5._rec(_ag5._tap(foo, 'arguments/0/object')[_ag5._tap(propName, 'arguments/0/property')], 'arguments/0'), new _AssertionMessage1(_am5, -1));
assert(_ag6._rec(_ag6._tap(foo, 'arguments/0/object')[_ag6._tap(func(_ag6._tap(key, 'arguments/0/property/arguments/0')), 'arguments/0/property')], 'arguments/0'), new _AssertionMessage1(_am6, -1));
assert(_ag7._rec(_ag7._tap(_ag7._tap(_ag7._tap(foo, 'arguments/0/object/object/object')[_ag7._tap(propName, 'arguments/0/object/object/property')], 'arguments/0/object/object')['key'], 'arguments/0/object')[_ag7._tap(_ag7._tap(keys(), 'arguments/0/property/object')['name'], 'arguments/0/property')], 'arguments/0'), new _AssertionMessage1(_am7, -1));
assert(_ag8._rec(_ag8._tap(_ag8._tap(_ag8._tap(foo, 'arguments/0/object/object/object')[_ag8._tap(propName, 'arguments/0/object/object/property')], 'arguments/0/object/object')['key'], 'arguments/0/object')[_ag8._tap(_ag8._tap(keys(), 'arguments/0/property/object')['name'], 'arguments/0/property')], 'arguments/0'), new _AssertionMessage1(_am8, -1));
assert.equal(_ag9._rec(_ag9._tap(ary1, 'arguments/0/object').length, 'arguments/0'), _ag10._rec(_ag10._tap(ary2, 'arguments/1/object').length, 'arguments/1'), new _AssertionMessage1(_am9, -1));
assert.deepEqual(_ag11._rec(_ag11._tap(foo, 'arguments/0/object').propName, 'arguments/0'), _ag12._rec(_ag12._tap(foo, 'arguments/1/object')[_ag12._tap(key, 'arguments/1/property')], 'arguments/1'), new _AssertionMessage1(_am10, -1));
