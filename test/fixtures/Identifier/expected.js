...
var _ag7 = new _ArgumentRecorder1(assert.equal, _am5, 2);
var _ag8 = new _ArgumentRecorder1(assert.equal, _am5, 2);
var _am6 = _pwmeta1(2, 'assert.equal(str, anotherStr)', 'path/to/some_test.js', 16);
var _ag9 = new _ArgumentRecorder1(assert.equal, _am6, 2);
var _ag10 = new _ArgumentRecorder1(assert.equal, _am6, 2);
var _am7 = _pwmeta1(2, 'assert.equal(str, yetAnotherStr)', 'path/to/some_test.js', 21);
var _ag11 = new _ArgumentRecorder1(assert.equal, _am7, 2);
var _ag12 = new _ArgumentRecorder1(assert.equal, _am7, 2);
