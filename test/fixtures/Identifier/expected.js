...
var _ag7 = new _ArgumentRecorder1(assert.equal, _am5, 0);
var _ag8 = new _ArgumentRecorder1(assert.equal, _am5, 1);
var _am6 = _pwmeta1(2, 'assert.equal(str, anotherStr)', 'path/to/some_test.js', 16);
var _ag9 = new _ArgumentRecorder1(assert.equal, _am6, 0);
var _ag10 = new _ArgumentRecorder1(assert.equal, _am6, 1);
var _am7 = _pwmeta1(2, 'assert.equal(str, yetAnotherStr)', 'path/to/some_test.js', 21);
var _ag11 = new _ArgumentRecorder1(assert.equal, _am7, 0);
var _ag12 = new _ArgumentRecorder1(assert.equal, _am7, 1);
assert(_ag1._rec(falsyStr, 'arguments/0'));
assert(_ag2._rec(falsyStr, 'arguments/0'), messageStr);
assert.equal(_ag3._rec(str, 'arguments/0'), _ag4._rec(anotherStr, 'arguments/1'));
assert.equal(_ag5._rec(str, 'arguments/0'), _ag6._rec(anotherStr, 'arguments/1'));
assert.equal(_ag7._rec(str, 'arguments/0'), _ag8._rec(anotherStr, 'arguments/1'), messageStr);
assert.equal(_ag9._rec(str, 'arguments/0'), _ag10._rec(anotherStr, 'arguments/1'));
assert.equal(_ag11._rec(str, 'arguments/0'), _ag12._rec(yetAnotherStr, 'arguments/1'));
