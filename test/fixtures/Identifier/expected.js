...
assert.equal(_ag4._rec(str, 'arguments/0'), _ag5._rec(anotherStr, 'arguments/1'));
assert.equal(_ag6._rec(str, 'arguments/0'), _ag7._rec(anotherStr, 'arguments/1'));
...
assert.equal(_ag11._rec(str, 'arguments/0'), _ag12._rec(anotherStr, 'arguments/1'));
assert.equal(_ag13._rec(str, 'arguments/0'), _ag14._rec(yetAnotherStr, 'arguments/1'));
