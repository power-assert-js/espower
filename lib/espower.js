...
(function (root, factory) {
    ...
    var deepCopy,
        handlers = {
            ...
            BinaryExpression: function (instrumentor, node) {
                return instrumentor.captureExpressionWithInfixOperator(node, 'binary');
            },

            LogicalExpression: function (instrumentor, node) {
                return instrumentor.captureExpressionWithInfixOperator(node, 'logical');
            },

            AssignmentExpression: function (instrumentor, node) {
                return instrumentor.captureExpressionWithInfixOperator(node, 'assignment');
            },
    ...
    function ensureOptionPrerequisites (options) {
        ...
        if (typeof options.destructive === 'undefined') {
            throw new Error('options.destructive should be specified.');
        }
        if (typeof options.powerAssertVariableName === 'undefined') {
            throw new Error('options.powerAssertVariableName should be specified.');
        }
    }
