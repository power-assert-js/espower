...
Instrumentor.prototype.captureRecursively = function (node) {
    ...
    case 'UpdateExpression':
        return that.captureUpdate(node, that.locationOf(node));
    default:
        return node;
    }
};
...
Instrumentor.prototype.captureUpdate = function (target, location) {
    return this.captureNode('update', target, location);
};
