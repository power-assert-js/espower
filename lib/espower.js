        ...
        estraverse.replace(result, {
            ...
            leave: function (currentNode, parentNode) {
                ...
                case syntax.Identifier:
                    ...
                    modifiedTree = instrumentor.captureNode('ident', currentNode, instrumentor.locationOf(currentNode));
                    break;
                case syntax.MemberExpression:
                    propLocation = instrumentor.propertyLocationOf(currentNode);
                    modifiedTree = instrumentor.captureNode('ident', currentNode, propLocation);
                    break;
                case syntax.CallExpression:
                    if (currentNode.callee.type === syntax.MemberExpression) {
                        modifiedTree = instrumentor.captureNode('funcall', currentNode, instrumentor.propertyLocationOf(currentNode.callee));
                    } else {
                        modifiedTree = instrumentor.captureNode('funcall', currentNode, instrumentor.locationOf(currentNode));
                    }
                    break;
                case syntax.UnaryExpression:
                    modifiedTree = instrumentor.captureNode('unary', currentNode, instrumentor.locationOf(currentNode));
                    break;
                case syntax.BinaryExpression:
                    infixOperatorLocation = instrumentor.infixOperatorLocationOf(currentNode);
                    modifiedTree = instrumentor.captureNode('binary', currentNode, infixOperatorLocation);
                    break;
                case syntax.LogicalExpression:
                    infixOperatorLocation = instrumentor.infixOperatorLocationOf(currentNode);
                    modifiedTree = instrumentor.captureNode('logical', currentNode, infixOperatorLocation);
                    break;
                case syntax.AssignmentExpression:
                    infixOperatorLocation = instrumentor.infixOperatorLocationOf(currentNode);
                    modifiedTree = instrumentor.captureNode('assignment', currentNode, infixOperatorLocation);
                    break;
                case syntax.UpdateExpression:
                    modifiedTree = instrumentor.captureNode('update', currentNode, instrumentor.locationOf(currentNode));
                    break;
                case syntax.NewExpression:
                    modifiedTree = instrumentor.captureNode('new', currentNode, instrumentor.locationOf(currentNode));
                    break;
