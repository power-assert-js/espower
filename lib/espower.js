...
(function (root, factory) {
        ...
        estraverse.replace(result, {
            ...
            leave: function (currentNode, parentNode) {
                ...
                if (modifiedTree && path && isLeavingAssertion(capturingStartPath, path)) {
                    instrumentedTree = instrumentor.captureAssertion(modifiedTree, canonicalCode, capturedMetaTree, capturedTokens);
    ...
    LineInstrumentor.prototype.captureAssertion = function (node, canonicalCode, metaAstTree, metaAstTokens) {
        var n = newNodeWithLocationCopyOf(node),
            props = [];
        addObjectTo(props, n, 'tree', metaAstTree);
        addObjectTo(props, n, 'tokens', metaAstTokens);
    ...
    function addObjectTo(props, createNode, name, data) {
        if (data) {
            addToProps(props, createNode, name, data);
        }
    }
