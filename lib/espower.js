...
(function (root, factory) {
    ...
    SourceInstrumentor.prototype.instrument = function (ast) {
        ...
        estraverse.replace(result, {
            enter: function (currentNode, parentNode) {
                ...
                if (argumentPath) {
                    ...
                    if (numberOfTargetArguments(currentNode, that.options) !== 0) {
                        ...
                        canonicalAst = deepCopy(parentNode);
                        estraverse.replace(canonicalAst, {
                        ...
                        canonicalCode = escodegen.generate(canonicalAst, that.options.escodegenOptions);
            ...
            leave: function (currentNode, parentNode) {
                ...
                if (path && assertionPath && isPathIdentical(assertionPath, path)) {
                ...
                subpath = path.slice(assertionPath.length);
                ...
                case syntax.NewExpression:
                    modifiedTree = that.captureNode(currentNode, subpath);
                    break;
                ...
                if (modifiedTree && path && isPathIdentical(argumentPath, path)) {
                    // leaving target argument
                    instrumentedTree = that.captureAssertion(modifiedTree, canonicalCode);
                    argumentPath = null;
    ...
    SourceInstrumentor.prototype.captureAssertion = function (node, canonicalCode) {
    ...
    SourceInstrumentor.prototype.captureNode = function (target, subpath) {
