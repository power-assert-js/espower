...
Instrumentor.prototype.captureRecursively = function (node) {
    ...
    case 'BinaryExpression':
        operatorLocation = that.operatorLocationOf(node); // BK: need to detect operator location before left/right instrumentation
    ...
    case 'AssignmentExpression':
        ...
        node.right = that.captureRecursively(node.right);
        return that.captureAssignment(node, operatorLocation);
