...
(function (root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['estraverse', 'deepcopy'], factory);
    } else if (typeof exports === 'object') {
        module.exports = factory(require('estraverse'), require('deepcopy'));
    } else {
        root.espower = factory(root.estraverse, root.deepcopy);
    }
}(this, function (estraverse, deepcopy) {
    'use strict';
    ...
    SourceInstrumentor.prototype.instrument = function (ast) {
        ...
        estraverse.traverse(result, {
            enter: function (currentNode, parentNode) {
                ...
                if (!parentNode || typeof currentNode.type === 'undefined') {
                    return;
                }
                if (currentNode.type === syntax.ExpressionStatement) {
                    expression = currentNode.expression;
                } else if (currentNode.type === syntax.ReturnStatement) {
                    expression = currentNode.argument;
                } else {
                    return;
                }
