...
(function (root, factory) {
    ...
    function ensureOptionPrerequisites (options) {
        ...
        if (typeof options.lineSeparator === 'undefined') {
            throw new Error('options.lineSeparator should be specified.');
        }
        if (typeof options.targetMethods !== 'object') {
            throw new Error('options.targetMethods should be specified.');
        }
