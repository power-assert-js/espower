...
const { NodeCreator, getOrCreateNode } = require('./create-node');
...
class AssertionVisitor {
  ...
  enter (controller) {
    ...
    this.metadataGeneratorIdent = this.generatePowerAssertMetadataGenerator(controller);
  }
  ...
  generatePowerAssertMetadataGenerator (controller) {
    ...
    const generateNode = () => {
      ...
      const funcNode = types.arrowFunctionExpression([
        ...
        types.variableDeclaration('const', [
          types.variableDeclarator(versionIdent, types.literal(configVersion)),
          types.variableDeclarator(patternsIdent, patternsNode)
        ]),
        types.returnStatement(types.callExpression(objectAssignMethod, [
          types.objectExpression([
            types.property(versionIdent, versionIdent, false, true),
            types.property(contentIdent, contentIdent, false, true),
            types.property(filepathIdent, filepathIdent, false, true),
            types.property(lineIdent, lineIdent, false, true)
          ]),
          extraIdent,
